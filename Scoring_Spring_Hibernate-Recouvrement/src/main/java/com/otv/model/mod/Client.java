...
// Generated 2 sept. 2014 18:12:09 by Hibernate Tools 3.4.0.CR1
...
public class Client implements java.io.Serializable {
	...
	public Integer getScoreClient() {
		return scoreClient;
	}

	public void setScoreClient(Integer scoreClient) {
		this.scoreClient = scoreClient;
	}

	@Column(name = "categorieSocioProfessionel", length = 50)
	...
	@Column(name = "secteurActivite", length = 50)
	...
	@Column(name = "paysNaissance", length = 50)
	...
	@Column(name = "adresseVille", length = 50)
	...
	@Column(name = "telephoneBureau", length = 50)
