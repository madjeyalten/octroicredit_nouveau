...
/**
 * Simulation1 generated by hbm2java
 */
@Entity
@Table(name = "simulation1", catalog = "ref")
public class Simulation1 implements java.io.Serializable {

	private Simulation1Id id;

	public Simulation1() {
	}

	public Simulation1(Simulation1Id id) {
		this.id = id;
	}
	...
	public Simulation1Id getId() {
		return this.id;
	}

	public void setId(Simulation1Id id) {
		this.id = id;
	}
