...
/**
 * Simulation2Id generated by hbm2java
 */
@Embeddable
public class Simulation2Id implements java.io.Serializable {
	...
	public Simulation2Id() {
	}

	public Simulation2Id(String compte, String intitule, String debitReport,
			String creditReport, String debitMouvement, String creditMovement,
			String debitSolde, String creditSolde, String dateAndHeure,
			String ratio) {
		this.compte = compte;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Simulation2Id))
			return false;
		Simulation2Id castOther = (Simulation2Id) other;
