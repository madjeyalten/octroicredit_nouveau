...
/**
 * DepenseexceptionId generated by hbm2java
 */
@Embeddable
public class DepenseexceptionId implements java.io.Serializable {
	...
	public DepenseexceptionId() {
	}

	public DepenseexceptionId(String libelle, Long credit, Long debit,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DepenseexceptionId))
			return false;
		DepenseexceptionId castOther = (DepenseexceptionId) other;
