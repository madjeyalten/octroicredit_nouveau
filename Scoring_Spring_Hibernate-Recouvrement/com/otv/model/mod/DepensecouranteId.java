...
/**
 * DepensecouranteId generated by hbm2java
 */
@Embeddable
public class DepensecouranteId implements java.io.Serializable {
	...
	public DepensecouranteId() {
	}

	public DepensecouranteId(String libelle, Long credit, Long debit,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DepensecouranteId))
			return false;
		DepensecouranteId castOther = (DepensecouranteId) other;
